...
silent only
cd ~/dev/reevoo/supermarket
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +14 supermarket.rb
badd +2 test/supermarket_test.rb
badd +0 spec/supermarket_test.rb
badd +1 spec/supermarket_spec.rb
badd +1 spec/spec_helper.rb
badd +0 myapp.rb
badd +1 lib/checkout.rb
badd +9 lib/catalog.rb
badd +0 products.json
args supermarket.rb
edit supermarket.rb
...
silent! normal! zE
let s:l = 21 - ((12 * winheight(0) + 9) / 18)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((18 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
